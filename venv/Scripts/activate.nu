...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\rusqu\PycharmProjects\ApiQuote (Roschin IVT-101)\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\rusqu\PycharmProjects\ApiQuote (Roschin IVT-101)\venv\Scripts\deactivate.nu'
